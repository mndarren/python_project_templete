...
latex_documents = [
    (master_doc, 'project_slug.tex', 'project_slug Documentation',
     'author_name', 'manual'),
]
...
man_pages = [
    (master_doc, 'project_slug', 'project_slug Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'project_slug', 'project_slug Documentation',
     author, 'project_slug', 'One line description of project.',
     'Miscellaneous'),
]
